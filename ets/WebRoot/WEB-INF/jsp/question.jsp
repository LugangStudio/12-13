...
<html>
	...
	<head>
		...
		if(question=="a"){alert("请选择一个问题再点击修改！");hadselect="flase";}
		var answer=$('#answer').val();
		var obj={"question":question,"answer":answer,"userId":userid};
		if(hadselect=="true"){
			$.ajax({
		type:'POST',
		url:'${pageContext.request.contextPath}/setquestion.action',
		...
		alert(data);
		//改一下css，，，好看而已！！！
		$('#em1').attr('class',"step-2 step");
		$('#em2').attr('class',"step-1 step");
		}})}
		});})
		</script>
					...
					<div class="am-container header">
						<ul class="message-l">
							<div class="topMessage">
								<div class="menu-hd">
									<a href="#" target="_top" class="h">${param.username } </a>
				...
				<div class="main-wrap">
					...
					<div class="m-progress">
						<div class="m-progress-list">
							<span class="step-1 step" id="em1">
                                <em class="u-progress-stage-bg"></em>
                                <i class="u-stage-icon-inner">1<em class="bg"></em></i>
                                <p class="stage-name">设置安全问题</p>
                            </span>
							<span class="step-2 step" id="em2">
                                <em class="u-progress-stage-bg"></em>
					...
					<form class="am-form am-form-horizontal">
						...
						<div class="am-form-group select">
							<label for="user-question2" class="am-form-label">问题一</label>
							<div class="am-form-content">
								<select data-am-selected id="question">
									<option value="a" selected>请选择安全问题</option>
						...
						<div class="am-form-group">
							...
							<div class="am-form-content">
								<input type="text" id="answer" placeholder="请输入安全问题答案">
							</div>
						</div>
						<div class="info-btn">
